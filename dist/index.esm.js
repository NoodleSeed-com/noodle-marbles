...
const Marble = ({ size = 100, seed = "default", className = "", variant = "primary", color, harmonyType = "triadic", blendMode = "multiply", animated = false, rotate = false, borderWidth = 30, borderColor = "rgba(255, 255, 255, 1)", }) => {
    ...
    const bubbles = React.useMemo(() => generateBubbles(numericSeed, variant, color, harmonyType), [numericSeed, variant, color, harmonyType]);
    ...
    return (React.createElement("div", { className: clsx("relative overflow-hidden rounded-full", className), style: {
        ...
        React.createElement("svg", { width: "100%", height: "100%", viewBox: "0 0 100 100", className: "absolute inset-0" },
            React.createElement("defs", null,
                React.createElement("clipPath", { id: `clip-${sanitizedSeed}` },
                    React.createElement("circle", { cx: "50", cy: "50", r: "50" })),
                bubbles.map((bubble) => {
                    var _a, _b, _c;
                    return (React.createElement("radialGradient", { key: bubble.id, id: bubble.id, cx: ((_a = bubble.gradientPattern) === null || _a === void 0 ? void 0 : _a.cx) || "50%", cy: ((_b = bubble.gradientPattern) === null || _b === void 0 ? void 0 : _b.cy) || "30%", r: ((_c = bubble.gradientPattern) === null || _c === void 0 ? void 0 : _c.r) || "70%" },
                ...
                React.createElement("radialGradient", { id: `base-gradient-${sanitizedSeed}`, cx: "50%", cy: "50%", r: "50%" },
                    React.createElement("stop", { offset: "0%", stopColor: "#ffffff", stopOpacity: "0.2" }),
                    React.createElement("stop", { offset: "100%", stopColor: "#f8fafc", stopOpacity: "0.05" })),
            ...
            React.createElement("g", { clipPath: `url(#clip-${sanitizedSeed})` },
                rotate && (React.createElement("animateTransform", { attributeName: "transform", type: "rotate", values: "0 50 50; 360 50 50", dur: "16s", repeatCount: "indefinite" })),
                React.createElement("circle", { cx: "50", cy: "50", r: "50", fill: color
                        ? bubbles.length > 0
