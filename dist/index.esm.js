...
const Marble = ({ size = 100, seed = "default", className = "", variant = "primary", customColors, animated = false, rotate = false, borderWidth = 30, borderColor = "rgba(255, 255, 255, 1)", }) => {
    ...
    const bubbles = React.useMemo(() => generateBubbles(numericSeed, variant, customColors), [numericSeed, variant, customColors]);
    ...
    return (React.createElement("div", { className: clsx("relative overflow-hidden rounded-full", className), style: {
        ...
        React.createElement("svg", { width: "100%", height: "100%", viewBox: "0 0 100 100", className: "absolute inset-0" },
            React.createElement("defs", null,
                bubbles.map((bubble) => (React.createElement("radialGradient", { key: bubble.id, id: bubble.id, cx: "50%", cy: "30%", r: "70%" },
